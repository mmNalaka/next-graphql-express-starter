...
export const Sidebar = () => {
  return (
    <aside className="flex flex-col h-screen">
      <div className="relative bg-indigo-50 dark:bg-gray-800">
        <div className="flex flex-col sm:flex-row sm:justify-around">
          <div className="w-72 h-screen">
            <div className="flex items-center justify-start mx-6 mt-10">
              <img className="h-10" src="/icons/rocket.svg" />
              <span className="text-green-700 dark:text-gray-300 ml-4 text-2xl font-bold">
                EMPRESS
              </span>
            </div>
            <nav className="mt-10 px-6 ">
              <a
                className="hover:text-gray-800 hover:bg-indigo-100 flex items-center p-2 my-6 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200  text-gray-600 dark:text-gray-400 rounded-lg "
                href="#"
              >
                <svg
                  width="20"
              ...
              <a
                className="hover:text-gray-800 hover:bg-indigo-100 flex items-center p-2 my-6 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200  text-gray-800 dark:text-gray-100 rounded-lg bg-indigo-100 dark:bg-gray-600"
                href="#"
              >
                <svg
                  width="20"
